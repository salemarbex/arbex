...
const ConsultantSectionAdmin = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const updates = [
                { section: 'consultant', field_key: 'title', field_value: formData.title },
                { section: 'consultant', field_key: 'subtitle', field_value: formData.subtitle },
            ...
            setFormData(prev => ({ ...prev, image_url: imageUrl, signature_url: signatureUrl }))
            toast.success('Consultant section updated successfully!')
        } catch (error) {
    ...
    if (loading) {
        return (
            <>
                <Head>
                    <title>Consultant Section - Arbex Law Admin</title>
                </Head>
                <AdminLayout title="Consultant Section">
        ...
        <>
            ...
            <AdminLayout title="Consultant Section">
                <div className="sectionAdminPage">
                    <Paper className="pageHeader">
                        <div className="headerContent">
                            <h2>Consultant Section</h2>
                            <p>Manage the Consultant section content and signature</p>
                        </div>
                    </Paper>
                    ...
                    <Paper className="formContainer">
                        <form onSubmit={handleSubmit}>
                            <Grid container spacing={3}>
                                ...
                                <Grid item xs={12}>
                                    <h3 className="sectionTitle">Consultant Image</h3>
                                </Grid>
                                <Grid item xs={12} md={6}>
                                    <div className="mediaUpload">
                                        <label>Profile Image (600x445 recommended)</label>
                                        <input
                                            type="file"
                                            accept="image/*"
                                ...
                                <Grid item xs={12} md={6}>
                                    <div className="mediaUpload">
                                        <label>Signature Image (PNG with transparent background)</label>
                                        <input
                                            type="file"
                                            accept="image/*"
                                            onChange={handleSignatureChange}
                                        />
                                        {(signaturePreview || formData.signature_url) && (
                                            <div className="signaturePreview">
                                                <img
                                                    src={signaturePreview || formData.signature_url}
                ...
                <style jsx global>{`
                    ...
                    .sectionAdminPage .signaturePreview {
                        margin-top: 15px;
                        padding: 10px;
                        background: #f5f5f5;
                        border-radius: 8px;
                    ...
                    .sectionAdminPage .signaturePreview img {
                        max-width: 200px;
                        height: auto;
                    }
...
export default ConsultantSectionAdmin
